 var gm = new Map();
  ...
  function grammsh2(mat, m, n){
  //m es el número de vectores, n corresponde a las dimensiones
  //tomaremos el primer vector como la base de inicio, por tanto iniciamos con el segundo vector
    while(m > 0)
      if(vecZ(mat, m, n, 0)){
        vecCrop(mat, m, n, 0);
        m--;
